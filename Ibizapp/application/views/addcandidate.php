            ...
            messages:
                    {
                        fName: {
                            ...
                            letterspace: 'Please Enter Characters only'
                        },
                        lName: {
                        ...
                        conCompany: {
                            required: 'Please Select Contact Company Name'
                        },
                        conPerson: {
                            required: 'Please Select Contact Person'
                        },
                        empName: {
                            lettersonly: 'Only alpahabets are allowed'
                        },
                        subPosition: {
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="span6">
                    ...
                    <input type="text" name="bd" class="datepicker bdate" id="bd" data-date-format="dd-mm-yyyy" readonly/>
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="span6">
                    ...
                    <input type="text" name="availDate" class="datepicker bdate" id="availDate" data-date-format="dd-mm-yyyy" readonly/>
